$(document).ready(function () {
    ...
    $("#login1").submit(
        ...
        function (event) {
            ...
            var qatar1 = parseInt($("#qatar1").val());

            var ecuador1 = parseInt($("#ecuador1").val());

            var senegal1 = parseInt($("#senegal1").val());

            var holanda1 = parseInt($("#holanda1").val());

            var qatar2 = parseInt($("#qatar2").val());

            var ecuador2 = parseInt($("#ecuador2").val());

            var senegal2 = parseInt($("#senegal2").val());

            var holanda2 = parseInt($("#holanda2").val());

            var qatar3 = parseInt($("#qatar3").val());

            var ecuador3 = parseInt($("#ecuador3").val());
